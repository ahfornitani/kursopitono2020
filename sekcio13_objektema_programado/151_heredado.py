...
class RipetaTasko(Tasko):
    ...
    def fini(self):
        ...
        return RipetaTasko(self.priskribo, nova_limdato, self.tagoj_kvanto)
...
def main():
    ...
    hejmo.taskoj.append(RipetaTasko("Ŝanĝi litotukojn", datetime.now(), 6))
    hejmo.taskoj.append(hejmo.serĉi("Ŝanĝi litotukojn").fini())
    print(hejmo)
